...
The code of this server is no longer in the backends directory due to abuse of the server after me integrating it wih this project, also I will publish a video at some point explaining the launcher's new features and why I close sourced the data backend of it... The rest of the launcher is, and will always remain open source...
